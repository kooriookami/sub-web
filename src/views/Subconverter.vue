        ...
        data() {
            return {
                            ...
                            options: [
                                {
                                    label: '我的配置',
                                    value:
                                        'https://raw.iny.app/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini'
                                },
                                {
                                    label: '我的配置2',
                                    value: 'https://raw.iny.app/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online_Full.ini'
                                },
                                {
                ...
                form: {
                    sourceSubUrl: '',
                    clientType: '',
                    customBackend: 'https://syncapi.kooriookami.top/sub?',
                    remoteConfig: 'https://raw.iny.app/ACL4SSR/ACL4SSR/master/Clash/config/ACL4SSR_Online.ini',
                    excludeRemarks: '',
                    includeRemarks: '',
                    filename: '',
                    emoji: true,
